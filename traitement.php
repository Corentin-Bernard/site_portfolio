...
/*Le destinataire*/
//$to="corentin.bernard.design@gmail.com";
$to="corentin-bernard@laposte.net";

/*Le sujet du message qui apparaitra*/
$sujet="contact via portfolio";
$msg = '';
...
$headers = 'From: Corentin Bernard graphic and web designer'."rn";
$headers .= "rn";
